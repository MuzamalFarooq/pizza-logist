                    ...
                    <div className="lg:col-span-1">
                        <div className="bg-white rounded-2xl shadow-2xl p-8 h-full">
                            ...
                            <div>
                                ...
                                <address className='text-lg font-semibold text-gray-700 leading-relaxed not-italic'>
                                    Johar Town,<br />
                                    Lahore, Punjab 54782,<br />
                                    Pakistan
                                </address>
                                <a
                                    href="https://maps.app.goo.gl/TDyKsStkjndEJqHC7"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="inline-block mt-3 text-sm font-semibold text-red-600 hover:text-red-700 transition-colors underline"
                                >
                                    View on Google Maps →
                                </a>
                            </div>
